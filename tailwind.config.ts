...
export default {
	...
	// 	require('@tailwindcss/typography'), // Texts styles (np. blogs)
	// 	require('@tailwindcss/aspect-ratio'), // Aspect ratio (np. images)
	// 	require('@tailwindcss/line-clamp'), // Limit number of line text
	// ],
} satisfies Config;
