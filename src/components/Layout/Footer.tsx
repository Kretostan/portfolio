...
const Footer = () => {
	...
	return <footer className={`flex flex-col-reverse md:flex-row items-center justify-center gap-3 sm:gap-4 py-3 w-full text-xs text-text-theme-2 bg-bg-theme-2`}>
		<p className="flex items-center gap-0.25"><span className="flex text-base">&copy;</span>{currentYear} Kretostan</p>
		<div className="flex flex-col sm:flex-row gap-4 sm:gap-5 pt-2 md:pt-0">
			...
			<a
				...
				rel="noopener noreferrer"
			>
				<Icon icon="linkedin" alt="Linkedin logo" height={14} width={14} themed />
				LinkedIn
			</a>
			<a
				className="flex items-center gap-1 hover:underline hover:underline-offset-4"
