...
const About = () => {
  ...
  return (
    <section id="about" className="flex flex-col gap-10 py-12 bg-bg-theme-1">
      <h3 className="flex flex-col md:flex-row justify-center items-center gap-2 md:gap-4 lg:gap-6 text-4xl font-black text-transparent bg-clip-text bg-linear-to-r from-accent-theme-1 to-accent-theme-2 font-header">{t("about.title")}</h3>
