...
const Projects = ({data}: ProjectsProps) => {
  ...
  return <div className="flex flex-wrap justify-center items-center gap-6 sm:gap-8 px-6 py-6 sm:py-8 mx-2 bg-bg-theme-2 rounded-xl">
    {"projects" in data && data.projects.map(project =>
    <div
